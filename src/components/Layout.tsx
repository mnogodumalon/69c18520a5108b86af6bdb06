...
const APP_TITLE = 'EventOrganizer Pro';
...
const navigation = [
  ...
  { name: 'Dienstleisterbuchung', href: '/dienstleisterbuchung', icon: IconCalendarCheck },
  { name: 'Einladungsmanagement', href: '/einladungsmanagement', icon: IconFileText },
  { name: 'Eventverwaltung', href: '/eventverwaltung', icon: IconCalendar },
  { name: 'Dienstleisterverwaltung', href: '/dienstleisterverwaltung', icon: IconFileText },
  { name: 'Gästeverwaltung', href: '/gaesteverwaltung', icon: IconFileText },
];

const externalNavigation = [
  { name: 'Schnelleinladung', href: '/gateway/apps/69c184f6015010b253236847?template=list_page', icon: IconFileText },
  { name: 'Dienstleisterbuchung', href: '/gateway/apps/69c184f6df4d84221a69b827?template=list_page', icon: IconCalendarCheck },
  { name: 'Einladungsmanagement', href: '/gateway/apps/69c184f5c06e59dd3b6338f5?template=list_page', icon: IconFileText },
  { name: 'Eventverwaltung', href: '/gateway/apps/69c184f5bfd71417289848b6?template=list_page', icon: IconCalendar },
  { name: 'Dienstleisterverwaltung', href: '/gateway/apps/69c184f5969c07591f98b0b7?template=list_page', icon: IconFileText },
  { name: 'Gästeverwaltung', href: '/gateway/apps/69c184ea0b376d3c797865b1?template=list_page', icon: IconFileText },
];
    ...
    <div className="min-h-screen bg-background">
      ...
      >
        ...
        <nav className="px-3 pt-4 space-y-0.5">
          <a
            href="/gateway/apps/69c184f6015010b253236847?template=list_page"
