...
interface GaesteverwaltungViewDialogProps {
  open: boolean;
  onClose: () => void;
  record: Gaesteverwaltung | null;
  onEdit: (record: Gaesteverwaltung) => void;
}

export function GaesteverwaltungViewDialog({ open, onClose, record, onEdit }: GaesteverwaltungViewDialogProps) {
  ...
  return (
    <Dialog open={open} onOpenChange={v => !v && onClose()}>
      <DialogContent className="max-w-lg max-h-[90vh] overflow-y-auto">
        <DialogHeader>
          <DialogTitle>Gästeverwaltung anzeigen</DialogTitle>
        </DialogHeader>
